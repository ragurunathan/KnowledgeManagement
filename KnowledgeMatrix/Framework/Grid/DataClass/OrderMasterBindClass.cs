...
namespace ShanuNestedDataGridView.DataClass
{
    ...
    class OrderMasterBindClass
    {
        ...
        public string Pass_Percentage { get; set; }
        public string Exam_Mode { get; set; }
        public string TestResult { get; set; }
        public string TestStatus { get; set; }

        public OrderMasterBindClass(string imgcol, string order_no, string table_id, string description, DateTime order_date,
            string waiter_id, string pass_Percentage, string exam_Mode,string testResult,string testStatus)
        {
            ImgCol = imgcol;
            Order_No = order_no;
            Table_ID = table_id;
            ...
            if (testResult == null)
                ...
                TestResult = "View Results";
            TestStatus = testStatus == "Not Taken" ? "Take a Test" : "Take Re-Test";
                    }
